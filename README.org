...
This project takes the full text of the Project Gutenberg edition of the catechism found at [[http://archive.org/stream/baltimorecatechi14551gut/14551.txt][archive.org]], and adds an ANTLR 4 grammar to parse it, so that it can be converted into a machine-readable format.
